...
<body>
	...
	<div class="container">
		<form action="${pageContext.request.contextPath}/modifyInfoProc.mem" method="post"
			id="modifyForm" name="modifyForm">
			...
			<div class="row">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="id" name="id"
						placeholder="아이디" value="${ dto.getId() }" readonly>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="nickname"
						name="nickname" placeholder="닉네임" value="${ dto.getNickname() }"
						readonly>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-12 mb-3">
					<input type="text" class="form-control" id="address" name="address"
						placeholder="${dto.getAddress()}" readonly>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-6 mb-3">
						<input type="text" id="postcode" placeholder="우편번호"
							name="postcode" class="form-control" readonly>
					</div>
					<div class="col-6 mb-3">
			...
			<div class="row foot">
				<div class="col-12 col align-self-start divModify">
					<button type="button" class="btn btn-secondary col-3" id="btn_home">홈으로</button>
	...
	<script>
		$(function() {
			...
			$('#phone1').val(oriPhone.substring(0, 3));
			$('#phone2').val(oriPhone.substring(3, 7));
			$('#phone3').val(oriPhone.substring(7, 11));
			...
			$('#btn_home').on('click', function() { //홈으로 버튼을 눌렀을때
				location.href = "${pageContext.request.contextPath}/";
			});
			
			$('#btn_submit').on('click',function(){
				$('#phone').val(	$('#phone1').val() + $('#phone2').val() + $('#phone3').val()	);
				let nicknameRegex = /[ㄱ-힣a-zA-Z0-9]{2,12}/g;
				let phoneRegex = /[0-9]{11}/g;
				if(!(nicknameRegex.test($('#nickname').val()))){
					alert("닉네임을 형식에 맞춰 입력해주세요.");
					return;
				}else if(!(phoneRegex.test($('#phone').val())) || $('#phone2').val() == null || $('#phone3').val() == null){
					alert("휴대폰 번호를 올바르게 입력하세요.");
					return
				} else if($('#postcode').val()== null || $('#roadAddress') == null){
